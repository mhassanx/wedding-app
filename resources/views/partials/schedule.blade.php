  <section class="schedule-section">
        ...
        <div class="events-grid">
          ...
          <div class="event-card">
            <div class="event-name">Walima</div>
            <div class="event-date">{{ $settings['walima_date'] }}</div>
            <div class="event-time">{{ $settings['walima_time'] }}</div>
            <div class="event-venue">{{ $settings['walima_venue'] }}</div>
          </div>
        </div>
      </section>